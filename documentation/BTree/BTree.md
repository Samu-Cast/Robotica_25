...
flowchart TD
    ...
    Sequence2 --> GoAround[GoAround]
    Sequence3 --> RecognitionAction2[RecognitionObstacle]
    Sequence3 --> SignalAction2[SignalObstacle]
    Sequence3 --> GoAround2[GoAround]
    Sequence0 ====> Sequence4[Sequence/-->]
    Sequence4 --> RecognitionAction3[RecognitionValve]
    Sequence4 --> ActiveValve[ActiveValve]
    Sequence4 --> GoHome[GoHome]
